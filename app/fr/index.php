...
<?php
    ...
    try {
        ...
        echo "Error when starting the session: " . $ex->getMessage();

        // Ajouter un bouton de redirection
        echo "<button onclick=\"window.location.href = '{$appdir['PATH_CUICUI_APP']}/admin{$phpfile['db_config']}';\">Configurer</button>";
