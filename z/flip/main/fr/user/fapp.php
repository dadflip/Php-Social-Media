...
<html lang="en">
    ...
    <body>
        ...
        <div class="content">
            ...
            <button onclick="toggleForm()" type="button" class="block">➲ FLIPBOX</button>
            ...
            <div style="margin-top: 80px; margin-left: 0%; margin-right: 0%;">
        ...
        <script src="https://code.jquery.com/jquery-3.6.4.min.js"></script>
        <script src="../_assets/js/flipapp.js"></script>
        <script>
